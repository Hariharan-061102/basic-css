...
<body >
  ...
  <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
    <div class="container-fluid justify-content-center">
      <a class="navbar-brand fs-2" href="#">OPTIMUS PRIME</a>
      ...
      <form class="d-flex">
        <input type="text" id="text_c" class="form-control me-2" placeholder="Type something...">
  ...
  <div class="jumbotron text-center container-fluid align-center">
    <div class="container">
      <h1>Empowering innovation with<br>precise engineering and<br>limitless creativity.</h1>      
      <div class="container">
  ...
  <footer class="footer fixed-bottom bg-light text-center">
    <b>Designed and Developed By Hariharan (212221230034)</b>
  </footer>
  ...
  <div class="container text-center align-center" style="padding-left: 10%;">
    <div class="row gx-3 gy-3">
      ...
      <div class="col-md-3 border border-white rounded text-white m-3">
        ...
        <p>Unlocking Innovation: Python<br>Paving the Way to Progress.</p>
      </div>
      <div class="col-md-3 border border-white rounded text-white m-3">
...
![image](https://github.com/Hariharan-061102/basic-css/assets/93427270/3e2c08db-b988-40cf-8724-ec99311a5b75)
![image](https://github.com/Hariharan-061102/basic-css/assets/93427270/80da0b45-e83a-46de-b8d5-abda9fbe9979)
![image](https://github.com/Hariharan-061102/basic-css/assets/93427270/e4de7464-94a3-4b2c-9836-c2a10bfb5fb2)
![image](https://github.com/Hariharan-061102/basic-css/assets/93427270/cb4f349c-72bc-4aef-8c6a-481bbcd52ed3)
